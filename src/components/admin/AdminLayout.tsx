...
export const ADMIN_NAV: AdminNavSection[] = [
  {
    titleCode: "ADMIN_SECTION_MAIN",
    title: "Main",
    items: [
      { to: "/admin/home",     labelCode: "ADMIN_NAV_HOME",     label: "Home",     icon: Home },
      { to: "/admin/accounts", labelCode: "ADMIN_NAV_ACCOUNTS", label: "Accounts", icon: Building2 },
      { to: "/admin/users",    labelCode: "ADMIN_NAV_USERS",    label: "Users",    icon: Users },
    ],
  },
  {
    titleCode: "ADMIN_SECTION_SETUP",
    title: "Setup",
    items: [
      { to: "/admin/installation",             labelCode: "ADMIN_NAV_INSTALLATION", label: "Installation",             icon: Server },
      { to: "/admin/platform-administrators",  labelCode: "ADMIN_NAV_PLATFORM_ADMINS", label: "Platform Administrators", icon: ShieldCheck },
      { to: "/admin/domains",                  labelCode: "ADMIN_NAV_DOMAINS",      label: "Domains",                  icon: Globe2 },
    ],
  },
  {
    titleCode: "ADMIN_SECTION_TEMPLATES",
    title: "Templates",
    items: [
      { to: "/admin/templates/use-cases", labelCode: "ADMIN_NAV_TEMPLATE_USECASE",  label: "Use Case Templates", icon: LayoutTemplate },
      { to: "/admin/templates/workflows", labelCode: "ADMIN_NAV_TEMPLATE_WORKFLOW", label: "Workflow Templates", icon: GitBranch },
      { to: "/admin/templates/forms",     labelCode: "ADMIN_NAV_TEMPLATE_FORM",     label: "Form Templates",     icon: FormInput },
      { to: "/admin/templates/roles",     labelCode: "ADMIN_NAV_TEMPLATE_ROLE",     label: "Role Templates",     icon: KeyRound },
      { to: "/admin/templates/kpis",      labelCode: "ADMIN_NAV_TEMPLATE_KPI",      label: "KPI Templates",      icon: Gauge },
    ],
  },
  {
    titleCode: "ADMIN_SECTION_CONFIGURATION",
    title: "Configuration",
    items: [
      { to: "/admin/authentication",    labelCode: "ADMIN_NAV_AUTHENTICATION",    label: "Authentication",    icon: Lock },
      { to: "/admin/integrations",      labelCode: "ADMIN_NAV_INTEGRATIONS",      label: "Integrations",      icon: Plug },
      { to: "/admin/notifications",     labelCode: "ADMIN_NAV_NOTIFICATIONS",     label: "Notifications",     icon: Bell },
      { to: "/admin/localization",      labelCode: "ADMIN_NAV_LOCALIZATION",      label: "Localization",      icon: Languages },
      { to: "/admin/validation-rules",  labelCode: "ADMIN_NAV_VALIDATION_RULES",  label: "Validation Rules",  icon: CheckCircle2 },
      { to: "/admin/geographies",       labelCode: "ADMIN_NAV_GEOGRAPHIES",       label: "Geographies",       icon: MapPinned },
    ],
  },
  {
    titleCode: "ADMIN_SECTION_GOVERNANCE",
    title: "Governance",
    items: [
      { to: "/admin/master-data-schemas",   labelCode: "ADMIN_NAV_MDMS_SCHEMAS",     label: "Master Data Schemas",   icon: Database },
      { to: "/admin/configuration-registry", labelCode: "ADMIN_NAV_CONFIG_REGISTRY", label: "Configuration Registry", icon: BookOpen },
  ...
  {
    titleCode: "ADMIN_SECTION_SUPPORT",
    title: "Support",
    items: [
      { to: "/admin/help",          labelCode: "ADMIN_NAV_HELP",          label: "Help",          icon: HelpCircle },
      { to: "/admin/documentation", labelCode: "ADMIN_NAV_DOCUMENTATION", label: "Documentation", icon: FileText },
    ...
    <>
      <div className="flex items-center gap-2 px-4 py-3.5 border-b border-white/5">
        ...
        <div className="leading-tight">
          <div className="text-[13px] font-semibold tracking-wide">DIGIT Platform</div>
