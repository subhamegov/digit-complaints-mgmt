...
export const DASHBOARD_CATALOGUE: DashboardDefinition[] = [
  ...
  },
  {
    ...
    layout: [
      { label: "Complaint volume", kind: "stat", span: 3 },
      { label: "Resolution rate", kind: "stat", span: 3 },
      { label: "Average resolution time", kind: "stat", span: 3 },
      { label: "Recurring complaints", kind: "stat", span: 3 },
      { label: "Complaint trend over time", kind: "chart", span: 8 },
      { label: "Complaints by service", kind: "chart", span: 4 },
      { label: "Geographic hotspot map", kind: "map", span: 7 },
      { label: "Complaints by locality", kind: "table", span: 5 },
      { label: "Recurring issue categories", kind: "table", span: 12 },
    ],
  },
  {
    id: "citizen",
    ...
    layout: [
      ...
      { label: "Resolution rate", kind: "stat", span: 3 },
      { label: "SLA compliance", kind: "stat", span: 3 },
      { label: "Complaint trends", kind: "chart", span: 8 },
      { label: "Complaints by service", kind: "chart", span: 4 },
      { label: "Resolution performance", kind: "chart", span: 5 },
      { label: "Geographic distribution", kind: "map", span: 7 },
    ],
