          ...
          <aside style={panelStyle} className="h-fit p-5">
            {selected ? (
              <>
                ...
                </div> : selected.status === "approved" ? <button type="button" onClick={() => navigate({ to: "/signup/provisioning", search: {} })} className="mt-6 flex h-11 w-full items-center justify-center gap-2 rounded-md font-medium" style={{ background: "#2D4FC4", color: "#FFFFFF" }}><Clock3 className="h-4 w-4" />View provisioning experience</button> : null}
              </>
