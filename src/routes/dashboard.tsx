...
export function DashboardPage() {
  ...
  const KPI_REGISTRY: KpiDef[] = useMemo(() => [
    ...
    { id: "csat", kind: "stat", label: "Citizen satisfaction", description: "Mean citizen satisfaction (1–5) across resolved complaints.", icon: ThumbsUp, intent: "positive", improveDirection: "up", getValue: () => canCustomize ? `${tu.csat}/5` : `${s.satisfaction}/5`, getDelta: () => "Across resolved", getDeltaValue: () => "0.2", getHistory: () => [3.9, 4.0, 3.8, 4.1, 4.0, 4.2, 4.3] },
